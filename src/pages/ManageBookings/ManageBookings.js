                                        ...
                                        <div className='d-flex justify-content-between'>
                                            {
                                                cart.status ?
                                                    ...
                                                    :
                                                    (<span className='mt-2'><span onClick={() => updateStatus(cart._id)} className="btn btn-outline-dark">Click To Accept</span></span>)
                                            }
                                            <span className="mt-2 text-center">
                                                <Link onClick={() => cancelBooking(cart._id)} className="btn btn-outline-dark" to="/managebookings">Delete Booking</Link>
                                            </span>
                                        </div>
                                    </div>
                                </div>
